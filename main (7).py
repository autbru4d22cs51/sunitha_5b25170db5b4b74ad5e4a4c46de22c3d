''' Implement a class called BankAcount that represents a bank account. The class should have private
...
class BankAccount:
  ...
  def withdraw(self, amount):
    if amount > 0 and amount <= self.__account_balance:
      self.__account_balance -= amount
      #self__account_balance = self.__account__balance - amount
...
# Create an instance to the BankAccount class
